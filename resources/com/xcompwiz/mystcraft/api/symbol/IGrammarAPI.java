...
public interface IGrammarAPI {
	 ...
	 * Example: {@code registerGrammarRule(1.0F, IGrammarAPI.TERRAINMOD, IGrammarAPI.BLOCK_STRUCTURE, "TerModLattice")}
	 * @param parent The token to expand
	 * @param weight The weight value applied to the rule (higher -> more common).  typically, 1 is common
