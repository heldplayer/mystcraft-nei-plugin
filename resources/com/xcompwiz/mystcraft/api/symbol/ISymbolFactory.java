 ...
 * These methods do not register the symbol directly.  Use the SymbolAPI for that.
 * @author xcompwiz
 */
public interface ISymbolFactory {

	/**
	 * Creates (but does not register!) a new 'Terrain Feature' symbol using a basic WorldGenerator object
	 * The WorldGenerator class must provide a default constructor (no parameters)
	 * It is not recommended that you use this method.  This is meant primarily for testing.  
	 * @param id The unique identifier for the symbol
