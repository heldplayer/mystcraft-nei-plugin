 ...
 * Implement and register this through the InstabilityAPI to add your own instability providers to Mystcraft
 */
public interface IInstabilityProvider {
	 ...
	 * The mechanic will only be added to a world if the world's instability score is contained within the described interval 
	 ...
	 * This will be called only once, no matter what level the provider is for the world (regardless of the number of times 'stacked')
	...
	/**
	 * Should return the maximum level of the mechanic or the number of times the provider can stack
