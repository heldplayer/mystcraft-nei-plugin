 ...
 * These are primarily handled/sent server side. LinkEventAllow is the only event ever sent client-side.
 * Any other client side functionality should be handled by listening on the server side and notifying the client via network message
 */
public abstract class LinkEvent extends Event {
	...
	/**
	 * Called when the entity enters the new world and their position has been set
	 */
