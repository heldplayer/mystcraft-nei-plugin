...
public interface ILinkingAPI {
	...
	/**
	 * Links (Teleports) the entity using the information provided by the link info object
	 * A valid link info object can be created using the other functions from this interface
	 */
